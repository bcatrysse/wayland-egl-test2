...
#ifndef WL_SIMPLE_SHELL_INTERFACE
#define WL_SIMPLE_SHELL_INTERFACE
/**
...
struct wl_simple_shell_listener {
	...
	void (*get_surfaces_done)(void *data,
				  struct wl_simple_shell *wl_simple_shell);
	/**
	 * sent for the response of is_surface_popup
	 *
	 * 
	 * @param parentSurfaceId this will be 0 if the popup does not have a parent or the surface is not a popup
	 * @param popup boolean for whether surface is a popup or not
	 */
	void (*popup_details)(void *data,
			      struct wl_simple_shell *wl_simple_shell,
			      uint32_t surfaceId,
...
#define WL_SIMPLE_SHELL_SET_SCALE 8
#define WL_SIMPLE_SHELL_GET_POPUP 9
#define WL_SIMPLE_SHELL_IS_SURFACE_POPUP 10
 ...
 * @ingroup iface_wl_simple_shell
 */
#define WL_SIMPLE_SHELL_POPUP_DETAILS_SINCE_VERSION 1
 ...
 * @ingroup iface_wl_simple_shell
 */
#define WL_SIMPLE_SHELL_SET_SCALE_SINCE_VERSION 1
/**
 * @ingroup iface_wl_simple_shell
 */
#define WL_SIMPLE_SHELL_GET_POPUP_SINCE_VERSION 1
/**
 * @ingroup iface_wl_simple_shell
 */
#define WL_SIMPLE_SHELL_IS_SURFACE_POPUP_SINCE_VERSION 1
...
wl_simple_shell_set_name(struct wl_simple_shell *wl_simple_shell, uint32_t surfaceId, const char *name)
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_NAME, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, name);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_VISIBLE, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, visible);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_GEOMETRY, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, x, y, width, height);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_OPACITY, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, opacity);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_ZORDER, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, zorder);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_GET_STATUS, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_GET_SURFACES, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0);
}
...
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_FOCUS, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId);
}
 ...
 */
static inline void
wl_simple_shell_set_scale(struct wl_simple_shell *wl_simple_shell, uint32_t surfaceId, wl_fixed_t scaleX, wl_fixed_t scaleY)
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_SET_SCALE, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, scaleX, scaleY);
}
 ...
 */
static inline void
wl_simple_shell_get_popup(struct wl_simple_shell *wl_simple_shell, uint32_t surfaceId, uint32_t parentSurfaceId, int32_t x, int32_t y, int32_t width, int32_t height)
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_GET_POPUP, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId, parentSurfaceId, x, y, width, height);
}
 ...
 */
static inline void
wl_simple_shell_is_surface_popup(struct wl_simple_shell *wl_simple_shell, uint32_t surfaceId)
{
	wl_proxy_marshal_flags((struct wl_proxy *) wl_simple_shell,
			 WL_SIMPLE_SHELL_IS_SURFACE_POPUP, NULL, wl_proxy_get_version((struct wl_proxy *) wl_simple_shell), 0, surfaceId);
}
